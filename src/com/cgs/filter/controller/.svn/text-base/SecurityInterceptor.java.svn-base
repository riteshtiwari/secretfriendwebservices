...
{
	static Map<String, Object> returnObj = new HashMap<String, Object>();
	public SecurityInterceptor() {
		returnObj.put("data", "Authorization fail,login again !");
		returnObj.put("success", false);
	}
    private static final String AUTHORIZATION_PROPERTY = "Authorization";
    private static final String AUTHENTICATION_SCHEME = "Basic";
    private static final ServerResponse ACCESS_DENIED = new ServerResponse(returnObj, 401, new Headers<Object>());;
    ...
    public ServerResponse preProcess(HttpRequest request, ResourceMethod methodInvoked) throws Failure, WebApplicationException
    {
        Method method = methodInvoked.getMethod();
         System.out.println("In SecurityInterceptor class");
       ...
       /* if(method.isAnnotationPresent(RolesAllowed.class))
        {
            ...
            //Is user valid?
            if( ! isUserAllowed(username,  encodedUserPassword))
            {
                return ACCESS_DENIED;
            }
        /*}*/
    ...
    private boolean isUserAllowed(final String username, final String encodedUserPassword)
    {
